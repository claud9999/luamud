...
create table mud_obj(id primary key, par_id references mud_obj(id), loc_id references mud_obj(id), own_id references mud_obj(id));
create table mud_prop(obj_id references mud_obj(id), name, type, val);
